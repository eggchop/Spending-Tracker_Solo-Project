...
class Transaction
  attr_reader :id, :price, :date_added
  ...
  def update
    sql = "UPDATE transactions SET (price,tag_id,merchant_id) = ($1,$2,$3) WHERE id = $4"
    values = [@price,@tag_id,@merchant_id,@id]
  ...
  # def convert_sql_datetime_to_ruby_date_object
